    ...
    <Box>
      ...
      <Container maxW={'container.xl'} minH={'100vh'} p={'16'}>
        ...
        <Stack
          ...
          p={'4'}
          alignItems={'center'}
          direction={['column', 'row']} // array is used for responsiveness, 0th index describes smaller screen and 1st index describes bigger screen size
        >
...
const MyCarousel = () => (
  ...
  >
    <Box w="full" h={'100vh'}>
      ...
      <Heading color={'black'} {...headingOptions}>
        Watch The Future
      </Heading>
    </Box>
    ...
    <Box w="full" h={'100vh'}>
      ...
      <Heading opacity={'70%'} color={'white'} {...headingOptions}>
        Future is Gaming
      </Heading>
    </Box>
    ...
    <Box w="full" h={'100vh'}>
      ...
      <Heading opacity={'60%'} color={'white'} {...headingOptions}>
        Night life is cool
      </Heading>
    </Box>
  </Carousel>
